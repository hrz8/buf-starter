...
export const file_altalune_v1_common: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate]);
...
/**
 * @generated from message altalune.v1.QueryMetaResponse
 */
export type QueryMetaResponse = Message<"altalune.v1.QueryMetaResponse"> & {
  /**
...
/**
 * Describes the message altalune.v1.QueryMetaResponse.
 * Use `create(QueryMetaResponseSchema)` to create a new message.
 */
export const QueryMetaResponseSchema: GenMessage<QueryMetaResponse> = /*@__PURE__*/
