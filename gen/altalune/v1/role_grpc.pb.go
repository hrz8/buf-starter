...
const (
	RoleService_QueryRoles_FullMethodName = "/altalune.v1.RoleService/QueryRoles"
	RoleService_CreateRole_FullMethodName = "/altalune.v1.RoleService/CreateRole"
	RoleService_GetRole_FullMethodName    = "/altalune.v1.RoleService/GetRole"
	RoleService_UpdateRole_FullMethodName = "/altalune.v1.RoleService/UpdateRole"
	RoleService_DeleteRole_FullMethodName = "/altalune.v1.RoleService/DeleteRole"
)
...
func (c *roleServiceClient) QueryRoles(ctx context.Context, in *QueryRolesRequest, opts ...grpc.CallOption) (*QueryRolesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryRolesResponse)
	err := c.cc.Invoke(ctx, RoleService_QueryRoles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRoleServiceServer) QueryRoles(context.Context, *QueryRolesRequest) (*QueryRolesResponse, error) {
...
func _RoleService_QueryRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).QueryRoles(ctx, req.(*QueryRolesRequest))
	}
...
var RoleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "altalune.v1.RoleService",
	...
	Metadata: "altalune/v1/role.proto",
}
