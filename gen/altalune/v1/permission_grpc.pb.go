...
const (
	PermissionService_QueryPermissions_FullMethodName = "/altalune.v1.PermissionService/QueryPermissions"
	PermissionService_CreatePermission_FullMethodName = "/altalune.v1.PermissionService/CreatePermission"
	PermissionService_GetPermission_FullMethodName    = "/altalune.v1.PermissionService/GetPermission"
	PermissionService_UpdatePermission_FullMethodName = "/altalune.v1.PermissionService/UpdatePermission"
	PermissionService_DeletePermission_FullMethodName = "/altalune.v1.PermissionService/DeletePermission"
)
...
func (c *permissionServiceClient) QueryPermissions(ctx context.Context, in *QueryPermissionsRequest, opts ...grpc.CallOption) (*QueryPermissionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryPermissionsResponse)
	err := c.cc.Invoke(ctx, PermissionService_QueryPermissions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPermissionServiceServer) QueryPermissions(context.Context, *QueryPermissionsRequest) (*QueryPermissionsResponse, error) {
...
func _PermissionService_QueryPermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryPermissionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PermissionServiceServer).QueryPermissions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionService_QueryPermissions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).QueryPermissions(ctx, req.(*QueryPermissionsRequest))
	}
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "altalune.v1.PermissionService",
	HandlerType: (*PermissionServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "QueryPermissions",
			Handler:    _PermissionService_QueryPermissions_Handler,
		},
		{
	...
	Metadata: "altalune/v1/permission.proto",
}
